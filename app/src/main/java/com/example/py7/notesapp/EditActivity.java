...
public class EditActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        titles=TxTitle.getText().toString().trim();
        details=TxDetail.getText().toString().trim();
    }
    ...
    public void update(){
        ...
        if (title.equals("") && detail.equals("")){
            Toast.makeText(EditActivity.this, "Nothing to updated", Toast.LENGTH_SHORT).show();
        }else {
    ...
    public boolean onOptionsItemSelected(MenuItem item){
        ...
        switch (item.getItemId()){
            case R.id.delete_edit:
                ...
                builder.setMessage("This lyrics will be deleted.");
                builder.setCancelable(true);
